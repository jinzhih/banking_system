...
<div id="header">
	...
	<div id="menu">
	<a href="index.html" id="homepage" >Homepage</a><a href="saving_transfer.php" id="back" >Back</a> <a href="saving_transaction.php" id="xx3" >Transactions</a> <a href="#" id="xx4" >eStatements</a> 
	</div> 
...
<?php
	...
	//	echo $select;
      ...
      $from_accountnumber = $rows2['ACCOUNT_NUMBER'];
	  	...
	  	$query3="select  * from TRANSACTION_FLOWS where (`FLOW_TIME` BETWEEN date_add(now(),interval -1 month) AND now()) AND (`USER_ID`='$session_id')AND(`ACCOUNT_TYPE`='1')";	
			...
			$Createtransaction1="INSERT INTO `TRANSACTION_FLOWS`( `DEBIT_AMOUNT`, `FLOW_TYPE`,  `PURPOSE`,`CURRENCY`, `TRANSACTION_CODE`, `USER_ID`, `ACCOUNT_TYPE`) VALUES ('2.5','estatement fee','estatement','AUD','$TRANSACTION_CODE','$session_id','1')";
      ...
      $from_accountnumber = $rows2['ACCOUNT_NUMBER'];
	  	...
	  	$query3="select  * from TRANSACTION_FLOWS where (`FLOW_TIME` BETWEEN date_add(now(),interval -3 month) AND now()) AND (`USER_ID`='$session_id')AND(`ACCOUNT_TYPE`='1')";	
			$result3 = $mysqli->query($query3);
			...
			$mysqli->query($Createtransaction);
			$Createtransaction1="INSERT INTO `TRANSACTION_FLOWS`( `DEBIT_AMOUNT`, `FLOW_TYPE`,  `PURPOSE`,`CURRENCY`, `TRANSACTION_CODE`, `USER_ID`, `ACCOUNT_TYPE`) VALUES ('5','estatement fee','estatement','AUD','$TRANSACTION_CODE','$session_id','1')";
			$mysqli->query($Createtransaction1);
      ...
      $from_accountnumber = $rows2['ACCOUNT_NUMBER'];
		  ...
		  $query3="select  * from TRANSACTION_FLOWS where (`FLOW_TIME` BETWEEN date_add(now(),interval -6 month) AND now()) AND (`USER_ID`='$session_id')AND(`ACCOUNT_TYPE`='1')";	
			$result3 = $mysqli->query($query3);
			...
			$mysqli->query($Createtransaction);
			$Createtransaction1="INSERT INTO `TRANSACTION_FLOWS`( `DEBIT_AMOUNT`, `FLOW_TYPE`,  `PURPOSE`,`CURRENCY`, `TRANSACTION_CODE`, `USER_ID`, `ACCOUNT_TYPE`) VALUES ('7','estatement fee','estatement','AUD','$TRANSACTION_CODE','$session_id','1')";
			$mysqli->query($Createtransaction1);
